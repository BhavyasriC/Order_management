...
public class CustomerOperation implements UserInterface {

//    private OrderProcessingWithDataBase order;

    public CustomerOperation(OrderProcessingWithDataBase order) {
//        this.order = order;
    }
    ...
    public void addcart() {
        ...
        try {
            ...
            int quantity = sc.nextInt();
            sc.nextLine(); 
            OrderProcessingWithDataBase.insertValues(new CartItem(customerId, productCode, quantity));
            ...
            while (true) {
                ...
                switch (choice) {
                    ...
                    case 3: 
                    	...
                    	break;
                    case 4:
                    	OrderProcessingWithDataBase.displayCart();;
                    	break;
                    case 5:
                    	OrderProcessingWithDataBase.removeFromCart();
                    	break;
                    case 6:
                        return;
                    default:
